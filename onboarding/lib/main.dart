...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // isOnboarded 값이 true인 경우 바로 HomePage 위젯을 보여주고, 그렇지 않은 경우 OnboardingPage 위젯
    ...
    return Scaffold(
      ...
      */
      body: IntroductionScreen(
        ...
        onDone: () {
          // Done 버튼을 눌렀을 때
          // OnboardingPage에서 Done 버튼을 누르는 시점에 온보딩을 완료
          // Done 클릭시 isOnboarded = true로 저장
          prefs.setBool("isOnboarded", true);

          // pushReplacement :  이동 후, 이전 페이지로 돌아갈 수 없음
